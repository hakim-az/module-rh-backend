...
export class YousignCdiController {
  ...
  async createSignaturerFR(
    ...
    // Définir les pages et les coordonnées X/Y pour chaque signataire
    const directorFields = [{ page: 5, x: 400, y: 300 }];

    const employeeFields = [{ page: 5, x: 40, y: 300 }];
